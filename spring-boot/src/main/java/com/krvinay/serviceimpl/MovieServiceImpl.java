...
import com.krvinay.exceptions.MovieAlreadyExistsException;
import com.krvinay.exceptions.NoDataFoundException;
...
public class MovieServiceImpl implements MovieService{
	...
	public MovieDto add(MovieDto movie) {
		...
		Optional<MovieEntity> exists=movieRespository.findByName(movie.getName());
	...
	public List<MovieDto> gets() {		
		...
		result.stream().findAny().orElseThrow(
				
				() -> new NoDataFoundException("No data")
